...
turn_RX = 3;
thickness_RX = 70;
Din_RX = Dout_RX - width_RX*2*turn_RX - space_RX*2*(turn_RX-1);
...
turn_TX = 5;
thickness_TX = 70;
Din_TX = Dout_TX - width_TX*2*turn_TX - space_TX*2*(turn_TX-1);

f = 13.56e6;
RA = 0.5;
RL = 100;
rho_RX = 1.72e-2;                           %in ohm*um, %Resistance of the conducting material
