...
RA = 0.10;                                  %in ohm, %Expected access resistance
...
R_TX = Res_tot6(space_TX, turn_TX, Dout_TX, Din_TX, sheet_TX, sheet_TX, 0, thickness_TX, f);
...
max_eta = 0;
for thickness_TX = max_thickness_TX/n_search_points : max_thickness_TX/n_search_points : max_thickness_TX
    max_n_TX = min(max_turn_coil, ((Dout_TX-Din_TX)/2+min_space_TX)/(min_space_TX+min_width_TX));
    for turn_TX = 5 : 1 : max_n_TX
        if turn_TX == 1
            space_TX = Din_TX;
            R_TX = Res_tot6(space_TX, turn_TX, Dout_TX, Din_TX, sheet_TX, sheet_TX, 0, thickness_TX, f);
            L_TX = wheelerTurns(space_TX, turn_TX, Dout_TX, Din_TX)   ;
            ...
            M = MFilament2(space_RX, turn_RX, Dout_RX, Din_RX, space_TX, turn_TX, Dout_TX, Din_TX, d+thickness_TX/2+thickness_RX/2);
            eta = maxPTEc_sweep_cap3(R_TX,L_TX,C_TX,R_RX,L_RX,C_RX,M,f,RL,5);
            if eta > max_eta
                max_eta = eta;
            ...
            max_space_TX = ((Dout_TX-Din_TX)/2-min_width_TX)/(turn_TX-1)-min_width_TX;
            for space_TX = min_space_TX : (max_space_TX-min_space_TX)/n_search_points : max_space_TX
                R_TX = Res_tot6(space_TX, turn_TX, Dout_TX, Din_TX, sheet_TX, sheet_TX, 0, thickness_TX, f);
                L_TX = wheelerTurns(space_TX, turn_TX, Dout_TX, Din_TX)   ;
                C_TX = distributedCap5(space_TX, turn_TX, Dout_TX, Din_TX, epsilon_TX, epsilon_TX, epsilon_TX, 5, 10, thickness_TX, 0, 0, f);
                M = MFilament2(space_RX, turn_RX, Dout_RX, Din_RX, space_TX, turn_TX, Dout_TX, Din_TX, d+thickness_TX/2+thickness_RX/2);
