function status=kplot_log(x,k,xlabel_,xmin,xmax,x_res,ymin,ymax,y_res)
  hold on;
  grid on;
  ...
  fs=10;lw=0.5;
  semilogx(x,k,'ko-','linewidth',lw,'markersize',3,'markerfacecolor','none')
